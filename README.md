# Netflix-Data-Cleaning-Preprocessing-Excel
📌 Objective
The primary objective of this project was to take a raw dataset of Netflix movies and TV shows and transform it into a high-quality, structured format. By resolving issues like missing values, inconsistent text casing, and non-standard date formats, to prepare it for Exploratory Data Analysis (EDA) or visualization.
...
Reconstruct date   =DATE(C2, MONTH(DATEVALUE(A2 & " 1")), B2)
from MDY format 
to proper DMY date
